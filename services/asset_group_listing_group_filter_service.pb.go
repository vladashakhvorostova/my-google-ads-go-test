...
var file_services_asset_group_listing_group_filter_service_proto_rawDesc = []byte{
	...
	0xe4, 0x93, 0x02, 0x48, 0x22, 0x43, 0x2f, 0x76, 0x31, 0x31, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f,
...
var file_services_asset_group_listing_group_filter_service_proto_goTypes = []interface{}{
	(*MutateAssetGroupListingGroupFiltersRequest)(nil),     // 0: google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersRequest
	(*AssetGroupListingGroupFilterOperation)(nil),          // 1: google.ads.googleads.v11.services.AssetGroupListingGroupFilterOperation
	(*MutateAssetGroupListingGroupFiltersResponse)(nil),    // 2: google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersResponse
	(*MutateAssetGroupListingGroupFilterResult)(nil),       // 3: google.ads.googleads.v11.services.MutateAssetGroupListingGroupFilterResult
	...
	(*resources.AssetGroupListingGroupFilter)(nil),         // 6: google.ads.googleads.v11.resources.AssetGroupListingGroupFilter
}
var file_services_asset_group_listing_group_filter_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersRequest.operations:type_name -> google.ads.googleads.v11.services.AssetGroupListingGroupFilterOperation
	4, // 1: google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersRequest.response_content_type:type_name -> google.ads.googleads.v11.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v11.services.AssetGroupListingGroupFilterOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v11.services.AssetGroupListingGroupFilterOperation.create:type_name -> google.ads.googleads.v11.resources.AssetGroupListingGroupFilter
	6, // 4: google.ads.googleads.v11.services.AssetGroupListingGroupFilterOperation.update:type_name -> google.ads.googleads.v11.resources.AssetGroupListingGroupFilter
	3, // 5: google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersResponse.results:type_name -> google.ads.googleads.v11.services.MutateAssetGroupListingGroupFilterResult
	6, // 6: google.ads.googleads.v11.services.MutateAssetGroupListingGroupFilterResult.asset_group_listing_group_filter:type_name -> google.ads.googleads.v11.resources.AssetGroupListingGroupFilter
	0, // 7: google.ads.googleads.v11.services.AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters:input_type -> google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersRequest
	2, // 8: google.ads.googleads.v11.services.AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters:output_type -> google.ads.googleads.v11.services.MutateAssetGroupListingGroupFiltersResponse
