...
var file_services_audience_insights_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_services_audience_insights_service_proto_init() {
	...
	file_services_audience_insights_service_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	file_services_audience_insights_service_proto_msgTypes[5].OneofWrappers = []interface{}{
