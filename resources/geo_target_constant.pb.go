...
type GeoTargetConstant struct {
	...
	Status enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus `protobuf:"varint,7,opt,name=status,proto3,enum=google.ads.googleads.v11.enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus" json:"status,omitempty"`
...
var file_resources_geo_target_constant_proto_goTypes = []interface{}{
	(*GeoTargetConstant)(nil),                                      // 0: google.ads.googleads.v11.resources.GeoTargetConstant
	(enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus)(0), // 1: google.ads.googleads.v11.enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus
}
var file_resources_geo_target_constant_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v11.resources.GeoTargetConstant.status:type_name -> google.ads.googleads.v11.enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus
