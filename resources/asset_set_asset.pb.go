...
type AssetSetAsset struct {
	...
	Status enums.AssetSetAssetStatusEnum_AssetSetAssetStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v11.enums.AssetSetAssetStatusEnum_AssetSetAssetStatus" json:"status,omitempty"`
}
...
var file_resources_asset_set_asset_proto_goTypes = []interface{}{
	(*AssetSetAsset)(nil), // 0: google.ads.googleads.v11.resources.AssetSetAsset
	(enums.AssetSetAssetStatusEnum_AssetSetAssetStatus)(0), // 1: google.ads.googleads.v11.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus
}
var file_resources_asset_set_asset_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v11.resources.AssetSetAsset.status:type_name -> google.ads.googleads.v11.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus
