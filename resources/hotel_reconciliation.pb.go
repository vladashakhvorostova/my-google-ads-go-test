...
type HotelReconciliation struct {
	...
	// value.
	Status enums.HotelReconciliationStatusEnum_HotelReconciliationStatus `protobuf:"varint,10,opt,name=status,proto3,enum=google.ads.googleads.v11.enums.HotelReconciliationStatusEnum_HotelReconciliationStatus" json:"status,omitempty"`
}
...
var file_resources_hotel_reconciliation_proto_goTypes = []interface{}{
	(*HotelReconciliation)(nil),                                        // 0: google.ads.googleads.v11.resources.HotelReconciliation
	(enums.HotelReconciliationStatusEnum_HotelReconciliationStatus)(0), // 1: google.ads.googleads.v11.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus
}
var file_resources_hotel_reconciliation_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v11.resources.HotelReconciliation.status:type_name -> google.ads.googleads.v11.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus
