...
type MetricGoal struct {
	...
	// conversions, etc.
	Metric enums.ExperimentMetricEnum_ExperimentMetric `protobuf:"varint,1,opt,name=metric,proto3,enum=google.ads.googleads.v11.enums.ExperimentMetricEnum_ExperimentMetric" json:"metric,omitempty"`
	// The metric direction of the goal. For example, increase, decrease, no
	// change.
	Direction enums.ExperimentMetricDirectionEnum_ExperimentMetricDirection `protobuf:"varint,2,opt,name=direction,proto3,enum=google.ads.googleads.v11.enums.ExperimentMetricDirectionEnum_ExperimentMetricDirection" json:"direction,omitempty"`
}
...
var file_common_metric_goal_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2f, 0x76, 0x31, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x65, 0x78, 0x70,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x45,
	...
	0x2e, 0x76, 0x31, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x0f, 0x4d, 0x65, 0x74,
...
var file_common_metric_goal_proto_goTypes = []interface{}{
	(*MetricGoal)(nil), // 0: google.ads.googleads.v11.common.MetricGoal
	(enums.ExperimentMetricEnum_ExperimentMetric)(0),                   // 1: google.ads.googleads.v11.enums.ExperimentMetricEnum.ExperimentMetric
	(enums.ExperimentMetricDirectionEnum_ExperimentMetricDirection)(0), // 2: google.ads.googleads.v11.enums.ExperimentMetricDirectionEnum.ExperimentMetricDirection
}
var file_common_metric_goal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v11.common.MetricGoal.metric:type_name -> google.ads.googleads.v11.enums.ExperimentMetricEnum.ExperimentMetric
	2, // 1: google.ads.googleads.v11.common.MetricGoal.direction:type_name -> google.ads.googleads.v11.enums.ExperimentMetricDirectionEnum.ExperimentMetricDirection
