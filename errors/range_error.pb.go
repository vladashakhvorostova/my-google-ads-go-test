...
var file_errors_range_error_proto_goTypes = []interface{}{
	(RangeErrorEnum_RangeError)(0), // 0: google.ads.googleads.v11.errors.RangeErrorEnum.RangeError
	(*RangeErrorEnum)(nil),         // 1: google.ads.googleads.v11.errors.RangeErrorEnum
}
